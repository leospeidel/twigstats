...
The main use-case of Twigstats is to compute <b>f2-statistics for pairs of populations</b>. The output can then directly be fed into functions of the admixtools2 R package (https://uqrmaie1.github.io/admixtools/index.html) to <b>compute any other f-statistic</b>.<br>
